...
if (global.panic == true && layer_background_get_sprite(back_id) == bg_desert)
	layer_background_sprite(back_id, bg_desertescape);
    
if (global.panic == true && layer_background_get_sprite(back_id) == bg_desertmountain)
...
if (global.panic == true && layer_background_get_sprite(back_id4) == bg_desertcloudH)
	layer_background_sprite(back_id4, spr_desertcloudHnight);
    
if (global.panic == true && layer_background_get_sprite(back_id4) == bg_desertcloud)
