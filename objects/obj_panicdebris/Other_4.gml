...
if (global.panic == 1 && layer_background_get_sprite(back_id) == 1148)
...
if (global.panic == 1 && layer_background_get_sprite(back_id4) == 1106)
    layer_background_sprite(back_id4, spr_desertcloudHnight);

if (global.panic == 1 && layer_background_get_sprite(back_id4) == 1150)
